...
$pkg = Join-Path $Root 'reminder'
# 0x9192 = CJK character "xing" (to wake up / remind)
$glyph = [string][char]0x9192
...
foreach ($t in $targets) {
  ...
  $brush = New-Object System.Drawing.Drawing2D.LinearGradientBrush(
    $rect,
    [System.Drawing.Color]::FromArgb(255, 91, 108, 255),
    [System.Drawing.Color]::FromArgb(255, 69, 83, 230),
    45.0
  )
